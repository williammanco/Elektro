...
void main() {
  ...
  float sparkLife = min(10.0*(1.0-min((sparkGridIndex.y+(realTime/sparkGridSize))/(24.0-20.0*sparkRandom),1.0)),1.0);
  vec3 sparks = vec3(0.0);

  if (sparkLife>0.0) {
    float sparkSize = sparkRandom*0.05;
